...
#define ExtensionName "Base Harvest"
...
AppId={{F07A1B1D-7F7A-4E62-88CE-F9D8C9451249}
...
Source: {#BuildDir}\Landis.Extension.BaseHarvest-v4.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Base Harvest 4.0.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Base Harvest"" "; WorkingDir: {#LandisPlugInDir}
